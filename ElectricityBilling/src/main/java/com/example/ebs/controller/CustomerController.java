...
public class CustomerController {
  ...
  public String update(@PathVariable("id") Long id,
      @jakarta.validation.Valid @ModelAttribute("customer") com.example.ebs.entity.Customer customerDetails,
      org.springframework.validation.BindingResult br) {
    if (br.hasErrors()) {
      return "customer/edit";
    }

    com.example.ebs.entity.Customer existingCustomer = repo.findById(id)
  ...
  public String confirmDelete(@PathVariable("id") Long id, Model m) {
    m.addAttribute("customer", repo.findById(id).orElseThrow());
  ...
  @PostMapping("/new")
  public String create(@ModelAttribute @Valid Customer c, BindingResult br) {
    if (br.hasErrors())
      return "customer/form";
